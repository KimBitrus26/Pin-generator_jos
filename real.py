...
def index():
    return jsonify({"message":"Click Endpoint https://kimkazongapp.herokuapp.com/pin to generate pin AND Endpoint /<serial_number>, paste seriala_number after .com to validate pin"})
